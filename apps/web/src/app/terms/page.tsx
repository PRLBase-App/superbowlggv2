...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl space-y-4 text-sm leading-relaxed text-brand-muted">
      ...
      <p>Coins are virtual currency with no cash value and cannot be withdrawn. Marketplace redemptions are fulfilled by third-party partners; we pass through promo codes as provided.</p>
